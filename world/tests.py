...
Trait classes
Some code here was duplicated from https://github.com/evennia/ainneve/blob/master/world/test_traits.py
"""
...
class TraitFactoryTestCase(EvenniaTest):
    ...
    def test_defaults_counter(self):
        ...
        self.assertEqual(bo.extra, {}.keys())
    ...
    def test_defaults_gauge(self):
        ...
        self.assertEqual(hp.extra, {}.keys())
