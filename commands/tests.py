...
class TestStop(UniqueMudCmdTest):
    ...
    def test_stop(self):
        ...
        self.call(command(), arg, wnt_msg)
        self.assertFalse(self.char1.get_status('busy'))
    ...
    def test_unstoppable(self):
        ...
        arg = "= punch char2"
        self.call(command(), arg)
        char1_busy_cmd = self.char1.get_cmd('busy')
        #char1_status_cmd = char1_status['cmd']
        char1_busy_cmd.unstoppable = True
        arg = "= stop"
...
class TestEcho(UniqueMudCmdTest):
    ...
    def test_no_help_entry(self):
        command = developer_cmds.CmdMultiCmd
        arg = "= help echo"
        wnt_msg = "No help found"
        self.call(command(), arg, wnt_msg)


class TestUMHelp(UniqueMudCmdTest):
